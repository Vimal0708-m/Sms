            ...
            <div class="col-lg-7 col-sm-12 col-xs-12">
                <div class="arti_single">
                    <div class="arti_img_two">
                        <img src="{{asset('frontend_assets/img/blog/3.jpg')}}" class="img-fluid" alt="Blog image" />
                    </div>
                    ...
                    <div class="arti_sp">
                        ...
                        <img src="{{asset('frontend_assets/img/blog/1.png')}}" class="img-fluid" alt="Blog image" />
                ...
                <div class="author_part">
                    ...
                    <div class="single_author">
                        <img src="{{asset('frontend_assets/img/blog/author.jpg')}}" alt="" />
                        <h4>Marina Mojo</h4>
                ...
                <div class="comments_part">
                    ...
                    <div class="single_comment">
                        <img src="{{asset('frontend_assets/img/blog/c1.jpg')}}" alt="" />
                    ...
                    <div class="single_comment sc_left">
                        <img src="{{asset('frontend_assets/img/blog/c3.jpg')}}" alt="" />
                        <h4>Kader Bhai</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ultricies quam nisi, vel
                            gravida enim accumsan id. Praesent justo quam, auctor et lorem in, pulvinar ornare orci.</p>
                    </div>
                    ...
                    <div class="single_comment single_comment_mbnone">
                        <img src="{{asset('frontend_assets/img/blog/c2.jpg')}}" alt="" />
                        <h4>Mark Linomi</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ultricies quam nisi, vel
                            gravida enim accumsan id. Praesent justo quam, auctor et lorem in, pulvinar ornare orci.</p>
                    </div>
            ...
            <div class="col-lg-5 col-sm-12 col-xs-12">
                ...
                <div class="sidebar-post">
                    ...
                    <div class="single_popular">
                        <a href="{{route('blog_single')}}"><img src="{{asset('frontend_assets/img/blog/blog-1.png')}}"
                                alt="" /></a>
                        <h5><a href="{{route('blog_single')}}">Supercharging Your SEO Game with AI Writing
                                Assistants</a></h5>
                    </div><!-- END SINGLE POPULAR POST -->
                    <div class="single_popular">
                        <a href="{{route('blog_single')}}"><img src="{{asset('frontend_assets/img/blog/blog-2.png')}}"
                                alt="" /></a>
                        <h5><a href="{{route('blog_single')}}">AI Writing Assistants and the Future of Content
                                Marketing</a>
                        </h5>
                    </div><!-- END SINGLE POPULAR POST -->
                    <div class="single_popular">
                        <a href="{{route('blog_single')}}"><img src="{{asset('frontend_assets/img/blog/blog-3.png')}}"
                                alt="" /></a>
                        <h5><a href="{{route('blog_single')}}">Enhancing Your E-commerce Store With AI Writing
                                Assistants.</a>
                        </h5>
                    </div><!-- END SINGLE POPULAR POST -->
                    <div class="single_popular">
                        <a href="{{route('blog_single')}}"><img src="{{asset('frontend_assets/img/blog/blog-4.png')}}"
                                alt="" /></a>
                        <h5><a href="{{route('blog_single')}}">Building your content strategy cannot get easier than
                                this.</a>
                        </h5>
                    </div><!-- END SINGLE POPULAR POST -->
                    <div class="single_popular">
                        <a href="{{route('blog_single')}}"><img src="{{asset('frontend_assets/img/blog/blog-5.png')}}"
                                alt="" /></a>
                        <h5><a href="{{route('blog_single')}}">This is the only read you would need before sitting down
                                to
                                prepare</a></h5>
                    </div><!-- END SINGLE POPULAR POST -->
                ...
                <div class="sidebar-post">
                    ...
                    <div class="sidebar-banner">
                        <a href="#"><img src="{{asset('frontend_assets/img/blog/banner.jpg')}}" class="img-fluid"
                                alt="" /></a>
                    </div><!-- END SOCIAL MEDIA POST -->
                </div><!-- END SIDEBAR POST -->
            </div>
