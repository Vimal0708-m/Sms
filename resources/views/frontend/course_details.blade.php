        ...
        <div class="row">
            <div class="col-lg-8 col-sm-8 col-xs-12">
                <div class="single_event_single">
                    <img alt="" class="img-fluid" src="{{asset('frontend_assets/img/sc.png')}}" />
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane show fade active" id="overview">
                            <div class="overview">
                                ...
                                <iframe width="900" height="506" src="https://www.youtube.com/embed/RXv_uIN6e-Y"
                                ...
                                <p>roin et eros varius, ornare turpis ac, dapibus nisi. Morbi luctus arcu non massa
                                    ...
                                    tincidunt sed
                                    feugiat id, suscipit in est. Proin laoreet orci quis augue eleifend varius. Donec
                                    hendrerit ex ut
                            ...
                            <div class="overview text-center">
                                <div class="instructor-item">
                                    <div class="instructor-thumb">
                                        <a href="#0"><img src="{{asset('frontend_assets/img/ins-details.png')}}"
                                                alt="instructor"></a>
                                    </div>
                            ...
                            <div class="client-review">
                                <div class="review-comments">
                                    ...
                                    <ul class="review-contents">
                                        <li>
                                            <div class="thumb">
                                                <img src="{{asset('frontend_assets/img/client04.png')}}" alt="course">
                                            </div>
                                            <div class="cont">
                                                ...
                                                <p>
                                                    ...
                                                    et culpa voluptatibus repellat voluptates aliquid minima
                                                </p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="thumb">
                                                <img src="{{asset('frontend_assets/img/client02.png')}}" alt="course">
                                            </div>
                                            <div class="cont">
                                        ...
                                        <li>
                                            <div class="thumb">
                                                <img src="{{asset('frontend_assets/img/client03.png')}}" alt="course">
                                            </div>
                                            <div class="cont">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12">
                ...
                <div class="related_course">
                    ...
                    <div class="single_rc">
                        <div class="rc_img">
                            <img src="{{asset('frontend_assets/img/rc-1.png')}}" alt="" />
                        </div>
                    ...
                    <div class="single_rc">
                        <div class="rc_img">
                            <img src="{{asset('frontend_assets/img/rc-2.png')}}" alt="" />
                        </div>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                    ...
                    <div class="single_rc">
                        <div class="rc_img">
                            <img src="{{asset('frontend_assets/img/rc-3.png')}}" alt="" />
                        </div>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
