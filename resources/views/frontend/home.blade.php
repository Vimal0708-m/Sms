...
<section class="home_bg hb_height"
    style="background-image: url({{asset('frontend_assets/img/bg/home-bg.jpg')}};  background-size:cover; background-position: center center;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div class="hero-text-img">
                    <img src="{{asset('frontend_assets/img/home-img2.png')}}" class="img-fluid" alt="" />
                    <div class="home_ps">
...
<section class="top_cat__area section-padding"
    style="background-image: url({{asset('frontend_assets/img/bg/shape-1.png')}});  background-size:cover; background-position: center center;">
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"
                data-wow-offset="0">
                <div class="ab_img">
                    <img src="{{asset('frontend_assets/img/about1.png')}}" class="img-fluid" alt="image">
                </div>
            </div>
            <!--- END COL -->
            <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="ab_content">
                    ...
                    <a class="btn_one" href="{{route('course')}}">View All Courses <i
...
<!-- START CATEGORY -->
<section class="top_cat__area section-padding"
    style="background-image: url({{asset('frontend_assets/img/bg/section-2.jpg')}};  background-size:cover; background-position: center center;">
    <div class="container">
        <div class="section-title text-center">
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="cat_list">
                    <ul>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e1.png')}}" alt="category-image" />
                                Digital
                                Marketing</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e2.png')}}" alt="category-image" />
                                UI/UX
                                Design</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e3.png')}}" alt="category-image" />
                                3D Visual
                                Design</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e4.png')}}" alt="category-image" />
                                Content
                                Marketing</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e5.png')}}" alt="category-image" />
                                Photography</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e6.png')}}" alt="category-image" />
                                Photo
                                Lifestyle</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e7.png')}}" alt="category-image" />
                                Art &
                                Design</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e8.png')}}" alt="category-image" />
                                Finance &
                                Banking</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e9.png')}}" alt="category-image" />
                                Graphic
                                Design</a></li>
                        <li><a href="#"><img src="{{asset('frontend_assets/img/e2.png')}}" alt="category-image" />
                                Interior
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="cour_btn">
                    <a href="{{route('course')}}" class="btn_one">View all Courses <i
                            class="ti-arrow-top-right"></i></a>
                </div>
            </div>
            <!--- END COL -->
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="single_course">
                    <div class="single_c_img">
                        <img src="{{asset('frontend_assets/img/course/1.png')}}" class="img-fluid" alt="course-image" />
                        <span>Education</span>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="single_course">
                    <div class="single_c_img">
                        <img src="{{asset('frontend_assets/img/course/2.png')}}" class="img-fluid" alt="course-image" />
                        <span>UI/UX</span>
                    </div>
                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                        class="fa fa-star"></i><i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="single_course">
                    <div class="single_c_img">
                        <img src="{{asset('frontend_assets/img/course/3.png')}}" class="img-fluid" alt="course-image" />
                        <span>Lifestyle</span>
                    </div>
                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                        class="fa fa-star"></i><i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="single_course">
                    <div class="single_c_img">
                        <img src="{{asset('frontend_assets/img/course/4.png')}}" class="img-fluid" alt="course-image" />
                        <span>Science</span>
                    </div>
                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                        class="fa fa-star"></i><i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="single_course">
                    <div class="single_c_img">
                        <img src="{{asset('frontend_assets/img/course/5.png')}}" class="img-fluid" alt="course-image" />
                        <span>Modern</span>
                    </div>
                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                        class="fa fa-star"></i><i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="single_course">
                    <div class="single_c_img">
                        <img src="{{asset('frontend_assets/img/course/6.png')}}" class="img-fluid" alt="course-image" />
                        <span>Marketing</span>
                    </div>
                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                        class="fa fa-star"></i><i class="fa fa-star"></i>
    ...
    <div class="container">
        <div class="row part_bg">
            ...
            <div class="col-lg-8 col-sm-8 col-xs-12 text-center">
                <div class="partner">
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/1.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/2.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/3.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/4.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/5.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/2.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/1.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/3.png')}}" alt="image"></a>
                    <a href="#"><img src="{{asset('frontend_assets/img/clients/4.png')}}" alt="image"></a>
        ...
        <div class="row">
            <div class="col-lg-12 vp_top wow fadeInUDown" data-wow-duration="1s" data-wow-delay="0.2s"
                ...
                <div class="video-area"
                    style="background-image: url({{asset('frontend_assets/img/bg/video.jpg')}};  background-size:cover; background-position: center center;">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="our-team">
                    <div class="team-content">
                        <a href="#"><img src="{{asset('frontend_assets/img/team/team1.jpg')}}" alt=""></a>
            ...
            <div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="our-team">
                    <div class="team-content">
                        <a href="#"><img src="{{asset('frontend_assets/img/team/team2.jpg')}}" alt=""></a>
                        <ul class="social-links">
                            <li><a href="#"><i class="fa-solid fa-x"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="our-team">
                    <div class="team-content">
                        <a href="#"><img src="{{asset('frontend_assets/img/team/team3.jpg')}}" alt=""></a>
                        <ul class="social-links">
                            <li><a href="#"><i class="fa-solid fa-x"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="our-team">
                    <div class="team-content">
                        <a href="#"><img src="{{asset('frontend_assets/img/team/team4.jpg')}}" alt=""></a>
                        <ul class="social-links">
                            <li><a href="#"><i class="fa-solid fa-x"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"
                data-wow-offset="0">
                <div class="ab_img">
                    <img src="{{asset('frontend_assets/img/about3.png')}}" class="img-fluid" alt="image">
                    <div class="home_ps2">
...
<section class="testi_area section-padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div class="ab_img">
                    <img src="{{asset('frontend_assets/img/review.png')}}" class="img-fluid" alt="image">
                </div>
            </div><!-- END COL -->
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        <img src="{{asset('frontend_assets/img/quote.png')}}" alt="" />
                        ...
                        <div class="testi_pic_title">
                            <img src="{{asset('frontend_assets/img/testimonial/1.png')}}" alt="">
                            <h4>Ajmain Adil</h4>
                            <p>Groton Inc</p>
                        </div>
                    </div><!-- END TESTIMONIAL -->
                    <div class="testimonial">
                        ...
                        <div class="testi_pic_title">
                            <img src="{{asset('frontend_assets/img/testimonial/2.png')}}" alt="">
                            <h4>Sharukh Khan</h4>
                            <p>Red Chili Inc</p>
                        </div>
                    </div><!-- END TESTIMONIAL -->
                    <div class="testimonial">
                        ...
                        <div class="testi_pic_title">
                            <img src="{{asset('frontend_assets/img/testimonial/3.png')}}" alt="">
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testi_pic_title">
                            <img src="{{asset('frontend_assets/img/testimonial/4.png')}}" alt="">
                            <h4>Ajmain Adil</h4>
                            <p>Groton Inc</p>
                        </div>
                    </div><!-- END TESTIMONIAL -->
                    <div class="testimonial">
                        ...
                        <div class="testi_pic_title">
                            <img src="{{asset('frontend_assets/img/testimonial/5.png')}}" alt="">
                            <h4>Ajmain Adil</h4>
                            <p>Groton Inc</p>
                        </div>
                    </div><!-- END TESTIMONIAL -->
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="single_blog">
                    ...
                    <div class="content_box">
                        <span>May 10, 2024 | <a href="{{route('blog')}}">Education</a></span>
                        <h2><a href="{{route('blog')}}">Professional Mobile Painting and Sculpting</a></h2>
                        <a class="btn_one" href="{{route('blog')}}">Read More <i class="ti-arrow-top-right"></i></a>
                    </div>
                </div>
            </div><!-- END COL-->
            <div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                ...
                <div class="single_blog">
                    ...
                    <div class="content_box">
                        <span>May 16, 2024 | <a href="{{route('blog')}}">Education</a></span>
                        <h2><a href="{{route('blog')}}">Professional Ceramic Moulding for Beginner</a></h2>
                        <a class="btn_one" href="{{route('blog')}}">Read More <i class="ti-arrow-top-right"></i></a>
                    </div>
                </div>
            </div><!-- END COL-->
            <div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s"
                ...
                <div class="single_blog">
                    ...
                    <div class="content_box">
                        <span>May 18, 2024 | <a href="{{route('blog')}}">Programing</a></span>
                        <h2><a href="{{route('blog')}}">Education Is About Create Leaders For Tomorrow </a></h2>
                        <a class="btn_one" href="{{route('blog')}}">Read More <i class="ti-arrow-top-right"></i></a>
                    </div>
                </div>
            </div><!-- END COL-->
