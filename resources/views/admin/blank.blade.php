...
@section('content')
    <div class="admin-shell">
        ...
        <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
            ...
            @include('layouts.admin.auth.sidebar_nav')
                ...
                <div class="container-fluid px-3 px-lg-4 py-4">
                    ...
                    <section class="panel blank-panel">
                        <div class="blank-state">
                            <img class="blank-visual" src="{{ asset('admin_assets/images/png/dasher-ai.png') }}"
                                alt="adminHMD assistant visual">
                            <h2 class="h4 mb-2">Blank Page</h2>
                            <p class="text-muted mb-4">Start a new admin screen from this clean, responsive page shell.
                            </p>
                            <a class="btn btn-primary" href="{{ route('components') }}"><i class="bi bi-grid-3x3-gap"
                                    aria-hidden="true"></i> Browse Components</a>
                        </div>
                    </section>
                </div>
            </main>
