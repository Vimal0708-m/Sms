                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="table-media">
                                            <img class="product-thumb"
                                                src="{{ asset('admin_assets/images/ecommerce/product-1.jpg') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-media">
                                            <img class="product-thumb"
                                                src="{{ asset('admin_assets/images/ecommerce/product-2.jpg') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-media">
                                            <img class="product-thumb"
                                                src="{{ asset('admin_assets/images/ecommerce/product-3.jpg') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-media">
                                            <img class="product-thumb"
                                                src="{{ asset('admin_assets/images/ecommerce/product-4.jpg') }}"
