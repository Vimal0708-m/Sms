                ...
                <div class="page-heading">
                    <div class="page-heading-copy">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Reusable form controls, validation states, and field
                                layouts.</p>
                        </div>
                    </div>
                        ...
                        <form class="panel needs-validation" novalidate>
                            <div class="panel-header">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Bootstrap-ready fields with custom validation
                                        feedback.</p>
                                </div>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-6"><label class="form-label" for="formName">Full
                                        name</label><input class="form-control" id="formName" required>
                                    <div class="invalid-feedback">Full name is required.</div>
                                </div>
                                <div class="col-md-6"><label class="form-label" for="formEmail">Email</label><input
                                        class="form-control" id="formEmail" type="email" required>
                                ...
                                <div class="col-md-6"><label class="form-label" for="formBudget">Budget</label><input
                                        class="form-control" id="formBudget" type="number" min="1" required>
                                    <div class="invalid-feedback">Enter a valid budget.</div>
                                </div>
                                <div class="col-12"><label class="form-label" for="formMessage">Message</label>
                                    <textarea class="form-control" id="formMessage" rows="5" required></textarea>
                                    <div class="invalid-feedback">Message is required.</div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end mt-4"><button class="btn btn-primary" type="submit"><i
                                        class="bi bi-send" aria-hidden="true"></i> Submit
                                    Form</button></div>
                        </form>
                    </div>
                    <div class="col-12 col-xl-5">
                        <div class="panel h-100">
                            ...
                            <div class="form-check"><input class="form-check-input" type="checkbox" id="sampleCheck"
                                    checked><label class="form-check-label" for="sampleCheck">Sample checkbox</label>
                            </div>
                        </div>
                    </div>
                </section>
