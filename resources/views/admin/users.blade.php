                    ...
                    <div class="page-heading-copy">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                Review accounts, roles, account status,
                                and team ownership.
                            </p>
                        </div>
                    </div>
                    <div class="heading-actions">
                        <a class="btn btn-outline-secondary btn-sm" href="{{ route('tables') }}"><i class="bi bi-download"
                                aria-hidden="true"></i>
                            Export</a><a class="btn btn-primary btn-sm" href="{{ route('adduser') }}"><i
                    ...
                    <div class="panel-header">
                        <div>
                            <h2 class="h5 mb-1 section-title">
                                <i class="bi bi-table" aria-hidden="true"></i><span>User List</span>
                            </h2>
                            <p class="text-muted mb-0">
                                Search, review, and manage team member
                                accounts.
                            </p>
                        </div>
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-primary btn-sm" href="{{ route('adduser') }}"><i class="bi bi-person-plus"
                                    aria-hidden="true"></i>
                                Add User</a>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle mb-0" id="usersTable" data-searchable-table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Jan 12, 2026</td>
                                    <td class="text-end">
                                        <a class="btn btn-light btn-sm" href="{{ route('user-details') }}">View</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-img avatar-sm"
                                                src="{{ asset('admin_assets/images/avatar/avatar-2.jpg') }}"
                                                alt="Rafi Khan" />
                                            <div>
                                                <p class="fw-semibold mb-0">
                                                    Rafi Khan
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-img avatar-sm"
                                                src="{{ asset('admin_assets/images/avatar/avatar-3.jpg') }}"
                                                alt="Nadia Islam" />
                                            <div>
                                                <p class="fw-semibold mb-0">
                                                    Nadia Islam
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-img avatar-sm"
                                                src="{{ asset('admin_assets/images/avatar/avatar-4.jpg') }}"
                                                alt="Mina Torres" />
                                            <div>
                                                <p class="fw-semibold mb-0">
                                                    Mina Torres
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-img avatar-sm"
                                                src="{{ asset('admin_assets/images/avatar/avatar-5.jpg') }}"
                                                alt="Jon Oliver" />
                                            <div>
                                                <p class="fw-semibold mb-0">
                                                    Jon Oliver
